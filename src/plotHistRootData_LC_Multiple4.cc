...
void plotHistRootData_LC_Multiple2(const std::string& folder1, const std::string& folder2 , const std::string& treeName, const std::string& branchName, const std::string& plotName, double xMin = -1, double xMax = -1, int nBins = 100, const std::string& saveFolder = ".")
{
   ...
   legend->AddEntry(hist2, "NSGA - 375x300 - air-gap", "l");
