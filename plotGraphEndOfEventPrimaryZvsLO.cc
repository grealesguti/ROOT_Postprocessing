...
void plotGraphEndOfEventPrimaryZvsLO(const std::string& folder,double yMax = 6500,
									 const std::string& saveFolder = "Figures/ZvsLO/")
{
	...
	plotRootScatterGraph_ZvsLO("../TierIIData/"+folder, "EndOfEvent", "fPrimaryZ", "EndOfEvent", "fphL","EndOfEvent", "fphR",
